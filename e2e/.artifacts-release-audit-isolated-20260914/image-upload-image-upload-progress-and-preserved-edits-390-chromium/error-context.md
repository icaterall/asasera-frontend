...
- Name: image-upload.spec.ts >> image upload progress and preserved edits 390
...
- banner "شريط المحرر":
  ...
  - textbox "عنوان النشاط": Image progress fixture
  - text: محفوظ
  - group "أدوات النشاط":
...
- main:
  ...
  - button "صورة الإجابة" [disabled]
  - progressbar "رفع الصورة"
