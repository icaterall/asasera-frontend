...
- Name: generation-account.spec.ts >> account deletion requires password confirmation, revokes access and clears shared-device state
- Location: e2e/generation-account.spec.ts:46:1

# Error details

```
Error: Command failed: /opt/homebrew/Cellar/node/24.10.0/bin/node --disable-warning=ExperimentalWarning scripts/v4/seed-browser-account.ts /tmp/asasera-browser-bfba30e8-4aea-4802-92c3-2129232a9b15.json
