...
- Name: billing-return.spec.ts >> billing return mobile-ar
...
Locator: getByRole('button', { name: /الرصيد المتاح:/ })
Expected substring: "129,000"
Received string:    "129 ألفرصيد"
Timeout: 5000ms

Call log:
  - Expect "toContainText" getByRole('button', { name: /الرصيد المتاح:/ }) with timeout 5000ms
  - waiting for getByRole('button', { name: /الرصيد المتاح:/ })
    8 × locator resolved to <button type="button" data-low="false" data-empty="false" data-compact="false" aria-expanded="false" aria-haspopup="dialog" class="asas _trigger_o52vc_1" title="الرصيد المتاح: 49,000" aria-label="الرصيد المتاح: 49,000. فتح الحساب والاستخدام">…</button>
      - unexpected value "49 ألفرصيد"
    6 × locator resolved to <button type="button" data-low="false" data-empty="false" data-compact="false" aria-expanded="false" aria-haspopup="dialog" class="asas _trigger_o52vc_1" title="الرصيد المتاح: 129,000" aria-label="الرصيد المتاح: 129,000. فتح الحساب والاستخدام">…</button>
      - unexpected value "129 ألفرصيد"

```

```yaml
- 'button "الرصيد المتاح: 129,000. فتح الحساب والاستخدام"':
  - strong: 129 ألف
  - text: رصيد
```
