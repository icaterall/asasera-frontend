...
export default function TeacherHome() {
  ...
  return <div className={`asas ${styles.page} ${home.dashboard}`}>
    ...
    <section className={home.hero} aria-labelledby="create-next-activity">
      ...
      <div className={home.heroArtwork}><img src={classroomImage} srcSet={`${classroomImageSmall} 640w, ${classroomImage} 1536w`} sizes="(max-width: 800px) 90vw, (max-width: 1200px) 45vw, 560px" width={1536} height={1024} fetchPriority="high" decoding="async" alt={ar ? 'رسم ثلاثي الأبعاد لمعلّمة وطلاب يستكشفون درسًا ملونًا معًا' : 'A colorful 3D illustration of a teacher and students exploring a lesson together'} /></div>
    </section>
