...
export default function Shelf() {
  ...
  return <div className={`asas ${base.page} ${styles.catalog}`}>
    ...
    {refs.isPending ? <LoadingState variant="form" label={t('جارٍ التحميل', 'Loading subjects and stages')} /> : refs.error ? <FailureState title={t('تعذّر تحميل خيارات البحث', 'Search options couldn’t load')} actions={<Button onClick={() => void refs.refetch()}>{t('إعادة المحاولة', 'Try again')}</Button>} /> : <>
