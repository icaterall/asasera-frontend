...
const en = {
  questionCreation: {
    ...
    "costOnConfirm": "Choose freely — nothing is counted yet. You will see the estimated cost to approve before anything is created.",
    "confirmLead": "Review the cost before continuing:",
    "confirmCreate": "Confirm and create",
    "confirmCancel": "Cancel",
    "uploadBusy": "Uploading your file and preparing its pages…",
