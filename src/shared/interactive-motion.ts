...
export const interactiveMotion={
 duration:{press:80,focus:140,panel:200,flip:260,deal:280,box:300,placement:180,feedback:160,challenge:360,spin:2400,result:240,completion:800},
 easing:{standard:'cubic-bezier(.2,0,0,1)',enter:'cubic-bezier(.16,1,.3,1)',exit:'cubic-bezier(.4,0,1,1)',spin:'cubic-bezier(.12,.78,.10,1)'},
