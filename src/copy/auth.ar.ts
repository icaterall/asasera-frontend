...
export const authAR: AuthCopy = {
  ...
  signup: {
    ...
    password: {
      title: 'اسمك وكلمة المرور',
      lead: 'خطوة أخيرة ويصبح حسابك جاهزًا.',
      edit: 'تعديل',
  ...
  callback: {
    ...
    signupIncomplete: 'لم يشاركنا المزوّد اسمك وبريدك الإلكتروني، وكلاهما مطلوب لإنشاء الحساب. اسمح بهما ثم أعد المحاولة، أو أنشئ حسابك ببريدك الإلكتروني.',
  },
