...
export const landingAr = {
  /* Document ------------------------------------------------------- */
  'meta.title': 'أساسيرا — ارفع ما تدرّسه. حوّله إلى اختبار.',
  'meta.description':
    'حوّل محتواك التعليمي إلى أنشطة تفاعلية. أنشئ أسئلة بالذكاء الاصطناعي، وقدّم تحديات مباشرة، وكلّف طلابك بالتدريب، وتابع تقدّمهم بالعربية والإنجليزية.',
